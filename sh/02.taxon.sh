...
#mkdir profile
#ls alignment/*/*species.abundance | profile - > profile/species.profile
#ls alignment/*/*genus.abundance   | profile - > profile/genus.profile
#ls alignment/*/*class.abundance   | profile - > profile/class.profile
#ls alignment/*/*family.abundance  | profile - > profile/family.profile
#ls alignment/*/*order.abundance   | profile - > profile/order.profile
#ls alignment/*/*phylum.abundance  | profile - > profile/phylum.profile
...
## 02.core
#mkdir 02.core
#perl /data_center_06/Project/pracrice/yehaocheng_20160120/analysis_with_all_raw_data/02.taxon_group1/bin/core_sum.pl sample.list profile/species.profile > 02.core/core.profile
