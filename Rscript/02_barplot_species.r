tax_level="species"
profile <- read.table("../profile/species.profile", header = T, check.names = F,quote="",sep="\t"，row.names=1)
number  <- 15
## reorder
...
## draw picture
pdf("species.barplot.pdf", height = 15, width = 15);
...
mtext("15 Main Species in Each Sample", side = 3, line = 1, cex = 2)
## legend
par(mar   = c(5, 5, 2, 2));
